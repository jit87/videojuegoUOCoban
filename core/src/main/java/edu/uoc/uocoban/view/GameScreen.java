    ...
    public void render(float delta) {
        ...
        if (!gameController.isLevelDeadlocked() && !gameController.hasLostGame() && !gameController.hasLostLevel()) {
            ...
            if (loaded) {
                ...
                game.font.draw(game.batch, "Movements " + gameController.getRemainingMovements(),25, 160);
                game.font.draw(game.batch, "Lives " + gameController.getLives(), 25, 160);
                game.font.draw(game.batch, "Score " + gameController.getScore(), 25, 160);
